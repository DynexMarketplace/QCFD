...
class QCFD:
    ...
    def compute(self, matrix, vector, compute='local',num_reads=1000,annealing_time = 200):
        ...
        if compute == 'dynex':
            ...
            sampleset = sampler.sample(num_reads=num_reads, annealing_time = annealing_time, debugging=False)
